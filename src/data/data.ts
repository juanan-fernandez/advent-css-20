export const Episodes = [
	...
	{
		id: 36,
		title: 'The Future of Programming Languages and Frameworks',
		description:
	...
	},
	{
		...
		description:
			"This is a crossover episode with our friends, Alex Patterson and Brittney Postma from the Purrfect.dev podcast. In this episode, we all discuss our jobs. Even though we're all in tech, our day- to - day work looks vastl different.",
	...
	{
		id: 34,
		title: 'Getting started in Open Source Development',
		description:
